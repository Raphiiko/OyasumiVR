...
import { ShutdownAutomationsService } from 'src/app/services/shutdown-automations.service';
import {
  ConfirmModalComponent,
  ConfirmModalInputModel,
  ConfirmModalOutputModel,
} from 'src/app/components/confirm-modal/confirm-modal.component';
import { SelectBoxItem } from 'src/app/components/select-box/select-box.component';
import { AUTOMATION_CONFIGS_DEFAULT, ShutdownAutomationsConfig } from 'src/app/models/automations';
