...
import { fade, triggerChildren, vshrink } from '../../../../../../utils/animations';
...
export class DeviceListComponent implements OnInit, OnDestroy {
  ...
  constructor(protected openvr: OpenVRService, private cdr: ChangeDetectorRef) {}
  ...
  turnOffDevices(devices: OVRDevice[]) {
    this.openvr.turnOffDevices(devices);
  }

  turnOffAllDevices() {
    this.openvr.turnOffDevices(flatten(this.deviceCategories.map((c) => c.devices)));
  }
}
