...
- :battery: 밤 사이의 전기 사용과 배터리를 절약하기
- :low_brightness: 헤드셋의 밝기를 어둡게 조절하기
- :sparkles: 잠자는 자세에 따라 아바타 애니메이션을 적용하기
- :envelope_with_arrow: 초대 요청을 자동으로 처리하기
- :microphone: 잠들었을 때 마이크를 음소거하기
- :hammer_and_wrench: 다양한 SteamVR 설정을 자동화하기
...
- 중국어 간체 (简体中文) (커뮤니티 번역 기여: [狐 Kon](https://github.com/XoF-eLtTiL), [雾雨花精灵](https://twitter.com/u_flower_elf))
