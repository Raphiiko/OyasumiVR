...
/**
 * @generated from protobuf message OyasumiOverlaySidecar.SetErrorReportingEnabledRequest
 */
export interface SetErrorReportingEnabledRequest {
  /**
...
// @generated message type with reflection information, may provide speed optimized methods
class SetErrorReportingEnabledRequest$Type extends MessageType<SetErrorReportingEnabledRequest> {
  constructor() {
    super('OyasumiOverlaySidecar.SetErrorReportingEnabledRequest', [
      { no: 1, name: 'enabled', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
    ]);
  }
  create(value?: PartialMessage<SetErrorReportingEnabledRequest>): SetErrorReportingEnabledRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.enabled = false;
    if (value !== undefined)
      reflectionMergePartial<SetErrorReportingEnabledRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: SetErrorReportingEnabledRequest
  ): SetErrorReportingEnabledRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: SetErrorReportingEnabledRequest,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bool enabled = 1; */
...
/**
 * @generated MessageType for protobuf message OyasumiOverlaySidecar.SetErrorReportingEnabledRequest
 */
