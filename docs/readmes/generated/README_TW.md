...
<p align="center">
    ...
    <a><img alt="開發版本狀態" src="https://github.com/Raphiiko/Oyasumi/actions/workflows/build-development.yml/badge.svg"/></a>
...
_（\*）Tundra 定位器回報電池電量與充電狀態的速度較慢，可能會有明顯延遲。_ 這表示電池自動化功能仍然可以正常運作，但觸發時間會有相當大的延遲（可能長達十幾分鐘），除非 Tundra 在其定位器韌體中修正這個問題。_
